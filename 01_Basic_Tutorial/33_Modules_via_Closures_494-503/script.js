...
// Это можно обойти добавив при подключении скрипта type="module", но тогда в последней задаче код не будет работать.
...
// myLibrary вынес в отдельный файл myLibrary.js
