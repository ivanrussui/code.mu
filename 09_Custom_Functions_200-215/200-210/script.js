...
// 209 Применение return в циклах

// 1 Напишите функцию, которая параметром будет принимать число и делить его на 2 столько раз, пока результат не станет меньше 10.
...
//
// // более оптимизированный результат
// function func2(num) {
//     let i = 0;
//     while (num >= 10) {
//         num /= 2;
